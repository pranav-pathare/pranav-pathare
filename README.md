...
- 🧩 Prototyping **multi-agent workflows** (e.g., a Lead Qualification Harness) for AI builder hackathons in Pune
- 🗓️ A **meeting scheduling agent** using the Anthropic API + Microsoft Graph
- 📚 Working through a structured **AI Engineering roadmap** — foundations, applied ML projects, and eventually MLOps
...
<p align="center"><i>⭐️ From an AdOps background to building AI agents — currently in progress.</i></p>
